...
* ``DEEPTUTOR_SANDBOX_RUNNER_URL`` and a non-empty
  ``DEEPTUTOR_SANDBOX_RUNNER_TOKEN`` set ⇒ authenticated runner sidecar
  (Docker deployment; a configured URL without a token fails closed);
