...
function sortedWeakDomains(domainBreakdown: PracticeDomainBreakdown[]): PracticeDomainBreakdown[] {
...
export function deriveWeakDomainLabels(domainBreakdown: PracticeDomainBreakdown[], limit = 2): string[] {
...
export function buildRetryTopic(topic: string, structuredResult: PracticeStructuredResult): string {
...
export function buildFlashcardSeedTopic(topic: string, structuredResult: PracticeStructuredResult): string {
