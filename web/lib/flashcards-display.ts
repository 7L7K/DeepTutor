import type { FlashcardDeck, FlashcardReviewMode, FlashcardSource } from "./flashcards-api";
...
export function getDeckSourceBadges(deck: Pick<FlashcardDeck, "sourceType" | "sourceSummary" | "sourceKbNames">): string[] {
