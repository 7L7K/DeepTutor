...
def phase4_real_auth_client(tmp_path, monkeypatch) -> TestClient:
    ...
    # This is an in-process HTTP TestClient proof. Do not inherit a deployment's
    # HTTPS-only cookie policy, which would correctly prevent the client from
    # returning a Secure cookie over its http://testserver origin.
